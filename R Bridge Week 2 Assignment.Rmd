...
_Please note that my data only had numeric values, which were not well suited for this task. I have decided to add a character column based on my data to do replace operations. The solution may include more than was requested, but it was great practice for me._
